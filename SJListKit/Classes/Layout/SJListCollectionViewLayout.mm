...
#import "SJListCollectionViewLayout.h"
#import <IGListKit/IGListCollectionViewLayoutInternal.h>
#import <IGListKit/UIScrollView+IGListKit.h>
...
@interface SJListCollectionViewLayoutInvalidationContext : UICollectionViewLayoutInvalidationContext
...
@implementation SJListCollectionViewLayoutInvalidationContext
@end

@interface SJListCollectionViewLayout ()
...
@implementation SJListCollectionViewLayout {
...
- (void)invalidateLayoutWithContext:(SJListCollectionViewLayoutInvalidationContext *)context {
...
+ (Class)invalidationContextClass {
    return [SJListCollectionViewLayoutInvalidationContext class];
}

- (UICollectionViewLayoutInvalidationContext *)invalidationContextForBoundsChange:(CGRect)newBounds {
    const CGRect oldBounds = self.collectionView.bounds;
    
    SJListCollectionViewLayoutInvalidationContext *context =
    (SJListCollectionViewLayoutInvalidationContext *)[super invalidationContextForBoundsChange:newBounds];
...
- (void)setStickyHeaderYOffset:(CGFloat)stickyHeaderYOffset {
    ...
    if (_stickyHeaderYOffset != stickyHeaderYOffset) {
        ...
        SJListCollectionViewLayoutInvalidationContext *invalidationContext = [SJListCollectionViewLayoutInvalidationContext new];
